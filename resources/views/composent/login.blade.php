<div x-data="{ modelOpen: false }">
    ...
    <button @click="modelOpen =!modelOpen" id="primaryButton"
        class="flex items-center justify-center px-4 py-2 mx-1 space-x-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform rounded-md btnmenu focus:outline-none focus:ring-opacity-50">
                ...
                <section class="">
                    ...
                    <div class="w-full max-w-md p-8 space-y-3 rounded-xl bg-[#EBF5FF] text-gray-100">
                        ...
                        <form novalidate="" action="/login" method="POST" class="space-y-6 ng-untouched ng-pristine ng-valid">
                            ...
                            <div class="space-y-1 text-sm">
                                <label for="password" class="block ml-2 text-left text-gray-400">Password</label>
                                <input type="password" name="password" id="password" placeholder="mot de passe" class="w-full px-4 py-3 text-gray-100 bg-indigo-100 border-gray-700 rounded-md focus:bg-white">
                                {{-- <div class="flex justify-end text-xs text-gray-400">
                                    <a rel="noopener noreferrer" href="#">Forgot Password?</a>
                                </div> --}}
                            </div>
                            <button class="block w-full p-3 text-center text-gray-900 rounded-sm bg-[#38ADA9]">Se connecter</button>
                        </form>
                        ...
                        <div class="flex justify-center space-x-4">
                         ...
                         <p class="text-xs text-center text-gray-400 sm:px-6">Pas encore de compte ?
                            <a rel="noopener noreferrer" href="#" @click="modelOpen = false"
                                onclick="document.getElementById('secondaryButton').click()"
                                class="text-black underline"> Inscrivez-vous</a>
                        </p> 
                    </div>
